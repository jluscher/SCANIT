...
siTitle = 'SCANIT for RetroSPEX [v030]'   # Program name and version
...
def editSettings():
    ...
    #
    #varEMhv,varREFhv,EM PMT high voltage (v),REF PMT high voltage (v)
    #-------
